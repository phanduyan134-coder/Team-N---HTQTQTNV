...
- **Cơ cấu phân bổ chuẩn mực theo Rubik (2 – 2 – 2)**:
  - *2 Quy trình Quản lý:* 4.1. Quản lý chuỗi cung ứng & 3.2. Quản lý chất lượng.
  - *2 Quy trình Cốt lõi:* 4.3. Bán thuốc tại nhà thuốc & 3.4. Bán thuốc online.
  - *2 Quy trình Hỗ trợ:* 4.5. Quản lý kho & 3.6. Tuyển dụng và đào tạo.
