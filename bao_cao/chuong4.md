...
*Hình 4.1: Sơ đồ BPMN 2.0 AS-IS – Quy trình Quản lý chuỗi cung ứng*
...
*Hình 4.2: Sơ đồ BPMN 2.0 AS-IS – Quy trình Quản lý chất lượng*
...
| **Thời gian trung bình** | Khoảng 13.5 phút/giao dịch (bao gồm thời gian chờ đợi và xử lý). |
...
*Hình 4.3: Sơ đồ BPMN 2.0 AS-IS – Quy trình Bán thuốc tại nhà thuốc*
...
*Hình 4.4: Sơ đồ BPMN 2.0 AS-IS – Quy trình Bán thuốc online*
...
*Bảng 4.5: Tóm tắt thông tin quy trình Quản lý kho (AS-IS)*
...
*Hình 4.5: Sơ đồ BPMN 2.0 AS-IS – Quy trình Quản lý kho*
...
*Hình 4.6: Sơ đồ BPMN 2.0 AS-IS – Quy trình Tuyển dụng và đào tạo*
