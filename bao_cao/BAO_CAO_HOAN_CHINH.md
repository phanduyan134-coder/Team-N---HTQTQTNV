...
- *Tuần 4 (Phân tích định tính & Định lượng chuyên sâu):* Phân loại và bóc tách chuỗi giá trị hoạt động VA/BVA/NVA cho 2 quy trình trọng điểm; phân tích lãng phí Lean Move-Hold-Overdo; xây dựng mô hình xương cá Fishbone 6M phân tích các bên liên quan và phân tích nguyên nhân gốc rễ bằng 5 Whys.
